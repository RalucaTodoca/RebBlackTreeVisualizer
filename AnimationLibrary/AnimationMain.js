...
function AnimationManager(objectManager)
{
	...
	// Toate animatiile sunt facute manipuland obiectele in acest cantainer
	this.animatedObjects = objectManager;

  //Controlul variabilelor pentru inceperea/incetarea animatiei

	this.animationPaused = false;
	this.awaitingStep = false;
	this.currentlyAnimating = false;

	// Array pentru codul animatiilor.  Acesta este un array
	//de string-uri, fiecare fiin o animatie
	// currentAnimation= indexul array-ului
	this.AnimationSteps = [];
	this.currentAnimation = 0;

	this.previousAnimationSteps = [];

	// controlul variabilelor pentru locul in care ne aflam in blocul de animatii
	//  currFrame=retine numarul frame-ului al blocului curent de naimatii,
	//  animationBlockLength=retinr lugimea animatiei curente holds
	//  block (in frame numbers).
	this.currFrame = 0;
	this.animationBlockLength = 0;

	//  Animatia curenta este activa
	this.currentBlock = null;

	// variabila pentru manipularea undo.

	this.undoStack = [];
	this.doingUndo = false;
  //o stiva continand inceputul fiecarui bloc de animatii ca index in AnimationSteps array
